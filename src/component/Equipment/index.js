                    ...
                    <div className="equipment_right_content_icon_1">                   
                            ...
                            <div  className="equipment_right_content_icon_2_nd">
                                <form >
                                    <select className="a">
                                        <option className="" value="Tất cả">Tất cả</option>
                                        <option className="" value="Kết nối">Kết nối</option>
                                        <option className="" value="Mất kết nối">Mất kết nối</option>
                                    </select>
                                </form>
                            </div>
                            ...
                            <div className="equipment_right_content_icon_3_nd">
                                <div className='a'>
                                    ...
                                    <input className="" type="text" placeholder="Nhập từ khóa " name="search"/>
                ...
                <div className="equipment_right_content_table">
                    <table className="equipment_right_content_table_device">
                        ...
                        <tr>
                            ...
                            <td>Kiosk</td>
                            <td>192.168.1.10</td>   
                            <td><span  className="redd"></span>Ngưng hoạt động</td>
                            <td><span  className="redd"></span>Mất kết nối</td>
                        ...
                        <tr>
                            ...
                            <td>192.168.1.10</td>
                            <td>Hoạt động</td>
                            <td><span  className="gren"></span>Kết nối</td>
                            <td>Khám tim mạch, Khám mắt...</td>
                            <td>Chi tiết</td>
                            <td>Cập nhập</td>
                        </tr>
